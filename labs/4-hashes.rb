...
puts "you have #{bitcoin} bitcoin(s)"
puts "one bitcoin is valued at $#{bitcoin_data ["bpi"]["USD"]["rate_float"]} USD"
puts "your bitcoin is worth $#{bitcoin_data ["bpi"]["USD"]["rate_float"] * bitcoin.to_f} USD"
